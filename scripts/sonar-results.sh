...
curl -v -H "Content-Type: application/json" -H "Authorization: Bearer fd88fe29c3526cdd8fe50ab1ad105d5c073f79c8" --request GET "https://sqprod.opsera.io/api/measures/component?component=Azure-service&metricKeys=bugs,vulnerabilities,security_hotspots"
